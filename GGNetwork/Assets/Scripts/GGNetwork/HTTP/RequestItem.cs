...
namespace GGFramework.GGNetwork
{
    public class RequestItem
    {
        ...
        public RequestItem(RequestType requestType, string httpAddress, string command, string paramData, Encoding dataEncode, HttpNetworkSystem.ExceptionAction exceptionAction, Action<JsonObject> callback)
        {
